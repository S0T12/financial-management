...
class Transfers extends Table {
  ...
  TextColumn get fromAccountId => text().references(Accounts, #id, onDelete: KeyAction.cascade)();
  TextColumn get toAccountId => text().references(Accounts, #id, onDelete: KeyAction.cascade)();
